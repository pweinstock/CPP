...
/*   Updated: 2022/03/31 17:45:34 by pweinsto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(void) : name("blank"), _signed(false), sign(150), exec(150)
{
	std::cout << "Form default constructor called" << std::endl;
}

Form::Form(std::string name, const int sign, const int exec) : name(name), _signed(false), sign(sign), exec(exec)
{
...
Form::Form(const Form &form) : name("blank"), sign(150), exec(150)
{
